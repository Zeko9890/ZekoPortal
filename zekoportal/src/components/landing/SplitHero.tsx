    ...
    <section className="relative min-h-screen bg-background overflow-hidden flex items-center pt-24 pb-20 transition-colors duration-500">
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-[1fr_1.05fr] gap-16 lg:gap-14 xl:gap-20 items-center">
        ...
        <div className="relative w-full h-[640px] flex items-center justify-center">
          ...
          <div 
            className={`absolute top-0 right-0 w-[115%] h-[580px] bg-white border border-gray-200/80 rounded-[14px] shadow-[0_24px_48px_-12px_rgba(0,0,0,0.08),0_4px_12px_-4px_rgba(0,0,0,0.03)] overflow-hidden flex transition-all duration-1000 ease-out delay-200 transform origin-right ${
              mounted ? "opacity-100 scale-100" : "opacity-0 scale-95"
            }`}
          >
            {/* Sidebar */}
            <div className="w-[180px] border-r border-gray-100 bg-gray-50/50 flex flex-col shrink-0 py-4 px-3">
              <div className="flex items-center gap-2.5 mb-8 px-2">
                <div className="h-6 w-6 rounded-[5px] bg-gray-900 flex items-center justify-center shadow-sm">
                  <span className="text-white font-extrabold text-[11px]">Z</span>
                </div>
                <span className="text-[13px] font-bold text-gray-900">ZekoPortal</span>
              </div>
                ...
                {[
                  ...
                  <div
                    ...
                    className={`flex items-center justify-between px-3 py-2 rounded-[6px] cursor-default transition-colors ${
                      active ? "bg-white border border-gray-200/60 shadow-sm text-gray-900" : "text-gray-500 hover:bg-gray-100/80 hover:text-gray-900"
                    }`}
                  >
                    <div className="flex items-center gap-3">
                      <Icon className={`h-4 w-4 ${active ? "text-sky-500" : "text-gray-400"}`} />
            ...
            <div className="flex-1 flex flex-col bg-white relative z-0">
              ...
              {/* Topbar */}
              <div className="h-16 border-b border-gray-100 flex items-center justify-between px-8 bg-white/80 backdrop-blur-md">
                ...
                <div className="flex items-center gap-6">
                  <div className="relative hidden md:block">
                    ...
                    <input 
                      ...
                      className="bg-gray-50 border border-gray-200 rounded-full h-8 w-48 pl-8 pr-4 text-[11px] text-gray-600 focus:outline-none"
                    />
                  </div>
                  <div className="flex -space-x-1.5">
                    {trustAvatars.slice(0, 3).map((a) => (
                      <div key={a.initials} className="h-6 w-6 rounded-full border-2 border-white text-[7px] font-bold text-white flex items-center justify-center shadow-sm"
                        style={{ backgroundColor: a.color }}>
                        {a.initials}
                      </div>
                    ))}
                    <div className="h-6 w-6 rounded-full border border-dashed border-gray-300 bg-gray-50 flex items-center justify-center text-gray-400">
              ...
              <div className="flex-1 p-8 overflow-hidden">
                <div className="mb-8">
                  <h2 className="text-[22px] font-bold text-gray-900 mb-1">Good morning, Alex 👋</h2>
                  <p className="text-[12px] text-gray-500">Here's what's happening with your workspace today.</p>
                </div>
                ...
                <div className="grid grid-cols-4 gap-4 mb-8">
                  {[
                    ...
                    <div key={i} className="bg-white border border-gray-200/80 rounded-[10px] p-4 flex flex-col shadow-sm card-hover">
                ...
                <div className="grid grid-cols-[1.5fr_1fr] gap-8">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-[13px] font-bold text-gray-900">Recent Projects</h3>
                      <span className="text-[11px] text-sky-500 font-semibold cursor-pointer">View all</span>
                    </div>
                    <div className="space-y-2.5">
                      {projectCards.slice(0, 4).map((proj, i) => (
                        <div key={i} className="flex items-center justify-between p-3 rounded-[8px] bg-white border border-gray-100 shadow-sm hover:border-gray-300 hover:shadow-md transition-all">
                          <div className="flex items-center gap-3">
                            ...
                            <span className="text-[12px] font-semibold text-gray-800">{proj.name}</span>
                          </div>
                          <span className={`text-[10px] font-bold px-2 py-1 rounded-[4px] ${
                            proj.status === "Completed" ? "bg-slate-100 text-slate-600" :
                            proj.status === "Review" ? "bg-orange-50 text-orange-600" :
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-[13px] font-bold text-gray-900">Team Activity</h3>
                      <span className="text-[11px] text-sky-500 font-semibold cursor-pointer">View all</span>
                    </div>
                        ...
                        <div key={i} className="flex items-start gap-3">
                          ...
                          <div className="flex flex-col">
                            <span className="text-[12px] text-gray-600 font-medium">
                              <span className="text-gray-900 font-bold">{item.user}</span> {item.action}
                            </span>
          ...
          <div 
            className={`absolute top-[25%] -right-[5%] w-[160px] glass-panel bg-white/95 backdrop-blur-xl border border-gray-200/80 rounded-[12px] p-4 shadow-premium transition-all duration-700 delay-500 ease-out z-20 ${
              mounted ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8"
            }`}
          >
            <h4 className="text-[11px] font-bold text-gray-900 mb-1">Team Productivity</h4>
            <div className="flex items-end gap-1 mb-4">
              <span className="text-xl font-bold text-gray-900">+24%</span>
              <span className="text-[9px] text-gray-500 mb-1">vs last week</span>
            </div>
          ...
          <div 
            className={`absolute -bottom-[5%] right-[10%] w-[220px] glass-panel bg-white/95 backdrop-blur-xl border border-gray-200/80 rounded-[12px] p-4 shadow-premium transition-all duration-700 delay-[600ms] ease-out z-20 ${
              mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
            <div className="flex items-center justify-between mb-3">
              <h4 className="text-[11px] font-bold text-gray-900">Upcoming Deadlines</h4>
              ...
              {[
                ...
                <div key={i} className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[11px] text-gray-800 font-medium">{task.label}</span>
                  </div>
          ...
          <div 
            className={`absolute -bottom-[8%] left-[30%] glass-panel bg-white/95 backdrop-blur-xl border border-gray-200/80 rounded-[12px] p-2 flex items-center gap-2 shadow-premium transition-all duration-700 delay-[700ms] ease-out z-20 ${
          ...
          >
            ...
            <div className="h-8 w-8 rounded-[8px] bg-gray-50 border border-gray-200 flex items-center justify-center cursor-pointer hover:bg-gray-100 transition-colors">
